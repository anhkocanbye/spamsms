...
- /help: Danh sách lệnh.
- /status: Hiển thị các tiến trình đang chạy
...
def status(message):
    ...
    try:
        ...
        bot.reply_to(message, '🚀Xin lỗi, hiện tại không thể kết nối đến Telegram API. Vui lòng thử lại sau.🚀')
